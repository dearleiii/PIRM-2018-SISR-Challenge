...
from apxm_ndf8k3 import APXM_ndf8k3
import srdata
...
def trainNet(net, batch_size, n_epochs, learning_rate):
    ...
    for epoch in range(n_epochs):
        ...
        plt.pause(0.001)
        figure.savefig("ndf8conv3_plot_epoch{:d}.png".format(epoch+1))
        ...
        if epoch > 5 and epoch % 5 == 0:
            ...
            plt.pause(0.001)
            fig_loss.savefig("ndf8conv3_training_loss{:d}.png".format(epoch+1))
        epoch_train_loss = 0.0

            
# To actually train the NN
trainNet(approximator, batch_size = 50, n_epochs = 40, learning_rate = 0.001)
print(time.asctime( time.localtime(time.time()) ))
#approximator.save_state_dict('APXM_4conv.pt')
torch.save(approximator.state_dict, '/home/home2/leichen/SuperResolutor/Approx_discrim/ndf8k3.pt')
torch.save(approximator, '/home/home2/leichen/SuperResolutor/Approx_discrim/ndf8k3_full.pt')
